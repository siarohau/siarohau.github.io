(function($) {
    jQuery.fn.dwCarousel = function(options) {
        ...
        function Main(obj) {
            ...
            this.li = this.ul.children(".slideItem");
        ...
        var calculateParams = function(windowSize) {
            ...
            if (options.resizeElement === true) { 
                if(options.resizeWidth !== false){
                    options.countElement = Math.floor($_this.outerWidth(true) / options.resizeWidth);
            ...
            if (options.countElement < $main.qtyLI) {
                ...
                $main.ul.css({cursor: "move"});

            } else {
                
                $main.ul.css({cursor: "default"});
